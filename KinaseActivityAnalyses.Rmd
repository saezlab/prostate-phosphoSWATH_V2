...
PDTs data to build the KSN. The LNCaP cell line tries to cluster togheter, 
but the abl lines inhibited with iPI3K separate them. We focus 
here in the analysis of some cluster of kinases that are active/unnactuve 
under certain conditions:

### ABL1, ABL2, LIMK1, LIMK2

These kinases are quite active in the non-inhibited LNCaP cell line during the 
first time point after treatment with EGF. I focused on this condition because
I know better the LNCaP cell lines and the potential effect of the EGF than 
other conditions under study. I therefore try to provide some biological 
insights. 
...
*Can this response explain the high activity of these kinases on t1 compare to t0?*
